"""Pytest fixtures for job_profile certifications feature tests."""
import uuid
import asyncio
import asyncpg
import pytest
...
def app():
    ...
    from app.features.job_profile.certifications.router import router as certifications_router
    application.include_router(certifications_router)
    return application
...
def authenticated_client(app):
    ...
    async def _setup():
        ...
        try:
            ...
            email = f"jp-cert-test-{uuid.uuid4().hex}@example.com"
