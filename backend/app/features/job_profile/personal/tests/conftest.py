"""Pytest fixtures for job_profile personal section tests."""
import uuid
import asyncio
import asyncpg
import pytest
...
def app():
    ...
    from app.features.job_profile.personal.router import router as personal_router
...
def authenticated_client(app):
    ...
    async def _setup():
        ...
        try:
            ...
            email = f"jp-personal-test-{uuid.uuid4().hex}@example.com"
