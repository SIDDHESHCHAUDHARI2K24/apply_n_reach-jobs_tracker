"""Pytest fixtures for job_profile projects section tests."""
import uuid
import asyncio
import asyncpg
import pytest
...
def app():
    ...
    from app.features.job_profile.projects.router import router as projects_router
...
def authenticated_client(app):
    ...
    async def _setup():
        ...
        try:
            ...
            email = f"jp-proj-test-{uuid.uuid4().hex}@example.com"
