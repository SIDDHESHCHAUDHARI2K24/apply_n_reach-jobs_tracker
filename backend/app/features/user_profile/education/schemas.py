"""Pydantic schemas for the education sub-feature."""
import re
...
class EducationCreate(BaseSchema):
    """Request schema for creating or updating an education entry."""
...
class EducationUpdate(BaseSchema):
    """Request schema for partially updating an education entry (all fields optional)."""
