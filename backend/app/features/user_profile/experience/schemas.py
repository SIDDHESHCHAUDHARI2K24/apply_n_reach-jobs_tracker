"""Pydantic schemas for the experience sub-feature."""
import re
...
class ExperienceCreate(BaseSchema):
    """Request schema for creating or updating an experience entry."""
...
class ExperienceUpdate(BaseSchema):
    """Request schema for partially updating an experience entry (all fields optional)."""
...
class ExperienceResponse(BaseSchema):
    """Response schema for an experience entry."""
