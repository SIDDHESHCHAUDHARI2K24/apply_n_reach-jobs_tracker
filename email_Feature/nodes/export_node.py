...
The UI status tracker (T4.4) takes over from here — it updates
outreach_status as the user copies, sends, and tracks replies.
"""

from __future__ import annotations

from state import OutreachState, GeneratedEmail


def export_node(state: OutreachState) -> dict:
    """
    ...
    # Apply user edits back onto the matching generated email
