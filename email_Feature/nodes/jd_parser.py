...
using a prompted Claude call. Handles varied JD formats (bullet lists,
...
from state import OutreachState, ParsedJD
...
def jd_parser(state: OutreachState) -> dict:
    """
    ...
    try:
        raw_json = chat(system=_SYSTEM, user=raw_jd, max_tokens=1024)
