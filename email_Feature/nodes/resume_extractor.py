...
def resume_extractor(state: OutreachState) -> dict:
    """
    ...
    # Build a compact JD summary for the prompt — we don't need to send the
    # full raw_text again, just the structured fields the extractor needs.
    jd_summary = (
    ...
    try:
        raw_json = chat(system=_SYSTEM, user=user_message, max_tokens=1024)
